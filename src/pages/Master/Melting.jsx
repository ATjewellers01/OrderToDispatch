...
export const SEEDED_MELTING = [
  { id: 'MELT-001', melting: '18K', timestamp: '2026-06-01T08:00:00.000Z' },
  { id: 'MELT-002', melting: '20K', timestamp: '2026-06-01T08:10:00.000Z' },
  { id: 'MELT-003', melting: '22K', timestamp: '2026-06-01T08:20:00.000Z' },
  { id: 'MELT-004', melting: '24K', timestamp: '2026-06-01T08:30:00.000Z' },
];

const EMPTY_FORM = { melting: '' };
...
export default function Melting({
  ...
  const handleEdit = (e) => {
    ...
    persist(meltingList.map(m => m.id === editMelting.id ? { ...m, melting: editMelting.melting.trim() } : m));
  ...
  const tableHeaders = ['Serial No', 'Timestamp', 'Melting', 'Action'];
      ...
      <tr key={m.id} className="hover:bg-amber-50/30 transition-colors border-b border-gray-100">
        ...
        <td className="px-4 py-3 text-center text-xs whitespace-nowrap">
          <div className="flex justify-center items-center gap-2">
            <button
              onClick={() => { setEditMelting({ id: m.id, melting: m.melting }); setShowEditModal(true); }}
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={e => setNewMelting({ melting: e.target.value })}
