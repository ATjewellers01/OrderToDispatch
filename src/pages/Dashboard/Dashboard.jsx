    ...
    <div className="p-4 sm:p-6 space-y-5 lg:space-y-6 bg-slate-50 h-full overflow-y-auto">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 space-y-4 transition-all hover:shadow-md duration-300">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <button 
            onClick={() => handleStatusClick('pending')}
            className="flex flex-col items-center justify-center p-3.5 border border-slate-200/80 rounded-xl hover:border-amber-500 hover:bg-amber-50/20 active:scale-95 transition-all duration-200 relative group shadow-sm"
          >
            <FolderCheck size={22} className="text-slate-500 group-hover:text-amber-500 mb-1.5 group-hover:scale-110 transition-transform" />
            <span className="text-xs font-black text-slate-600">Pending Orders</span>
            <span className="absolute -top-1.5 -right-1.5 bg-emerald-550 text-white text-[9px] font-black px-2 py-0.5 rounded-full leading-none shadow border border-emerald-400 font-mono">
              {pendingCount}
            </span>
          </button>
          ...
          <button 
            ...
            className="flex flex-col items-center justify-center p-3.5 border border-slate-200/80 rounded-xl hover:border-amber-500 hover:bg-amber-50/20 active:scale-95 transition-all duration-200 relative group shadow-sm"
          >
            <Folder size={22} className="text-slate-500 group-hover:text-amber-500 mb-1.5 group-hover:scale-110 transition-transform" />
            <span className="text-xs font-black text-slate-600">New Orders</span>
            <span className="absolute -top-1.5 -right-1.5 bg-amber-550 text-white text-[9px] font-black px-2 py-0.5 rounded-full leading-none shadow border border-amber-400 font-mono">
              {newCount}
            </span>
          </button>
          ...
          <button 
            ...
            className="flex flex-col items-center justify-center p-3.5 border border-slate-200/80 rounded-xl hover:border-amber-500 hover:bg-amber-50/20 active:scale-95 transition-all duration-200 relative group shadow-sm"
          >
            <Hourglass size={22} className="text-slate-500 group-hover:text-amber-500 mb-1.5 group-hover:scale-110 transition-transform" />
            <span className="text-xs font-black text-slate-600">In Progress</span>
            <span className="absolute -top-1.5 -right-1.5 bg-sky-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full leading-none shadow border border-sky-450 font-mono">
              {inProgressCount}
            </span>
          </button>
          ...
          <button 
            ...
            className="flex flex-col items-center justify-center p-3.5 border border-slate-200/80 rounded-xl hover:border-amber-500 hover:bg-amber-50/20 active:scale-95 transition-all duration-200 relative group shadow-sm"
          >
            <Hourglass size={22} className="text-slate-550 group-hover:text-amber-500 mb-1.5 group-hover:scale-110 transition-transform" />
            <span className="text-xs font-black text-slate-600">Over Due</span>
            <span className="absolute -top-1.5 -right-1.5 bg-rose-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full leading-none shadow border border-rose-400 font-mono">
              {overdueCount}
            </span>
          </button>
          ...
          <button 
            ...
            className="flex flex-col items-center justify-center p-3.5 border border-slate-200/80 rounded-xl hover:border-amber-500 hover:bg-amber-50/20 active:scale-95 transition-all duration-200 relative group shadow-sm"
          >
            <CheckCircle2 size={22} className="text-slate-550 group-hover:text-amber-500 mb-1.5 group-hover:scale-110 transition-transform" />
            <span className="text-xs font-black text-slate-600">Completed</span>
            <span className="absolute -top-1.5 -right-1.5 bg-emerald-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full leading-none shadow border border-emerald-400 font-mono">
              {completedCount}
            </span>
          </button>
          ...
          <button 
            ...
            className="flex flex-col items-center justify-center p-3.5 border border-slate-200/80 rounded-xl hover:border-amber-500 hover:bg-amber-50/20 active:scale-95 transition-all duration-200 relative group shadow-sm"
          >
            <Clock size={22} className="text-slate-500 group-hover:text-amber-500 mb-1.5 group-hover:scale-110 transition-transform" />
            <span className="text-xs font-black text-slate-600">Dispatched</span>
            <span className="absolute -top-1.5 -right-1.5 bg-purple-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full leading-none shadow border border-purple-400 font-mono">
              {dispatchedCount}
            </span>
          </button>
            ...
            {sellingProductsData.length > 0 ? (
              <div className="w-full h-[220px] relative">
                ...
                <div className="absolute bottom-2 left-1/2 -translate-x-1/2 text-center">
                  <span className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest block leading-none">Top</span>
                  <span className="text-sm font-black text-slate-700 leading-none">Selling Products</span>
                </div>
              </div>
            ) : (
